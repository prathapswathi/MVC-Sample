...
class Product{
    ...
    function create(){
        ...
        $query = "INSERT INTO
                    " . $this->table_name . "
                SET
                    Products=:Products,chap_id=:chap_id, Product_part=:Product_part,falg=:flag";
...
function search(){
  ...
  //  $this->searchitem=htmlspecialchars(strip_tags($this->searchitem)); 
    $query = "SELECT
                *
            FROM
                " . $this->table_name . " 
            WHERE
            Products LIKE '%$this->searchitem%'  ";
